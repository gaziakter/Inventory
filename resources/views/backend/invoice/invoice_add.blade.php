            ...
            <div class="row">
                <div class="col-md-1">
                    <div class="md-3">
                        ...
                        <div class="form-group col-sm-10">
                            <input name="invoice_no" class="form-control example-date-input" id="invoice_no" type="text" readonly style="background-color: $ddd;" value="{{$invoice_no}}">
                        </div>
                    </div>
                </div>
                <div class="col-md-2">
                    <div class="md-3">
                        ...
                        <div class="form-group col-sm-10">
                            <input name="name" class="form-control example-date-input" id="date" type="date" value="{{$date}}">
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-1">
                    <div class="md-3">
                        ...
                        <div class="form-group col-sm-10">
                            <input name="current_stock_qty" class="form-control example-date-input" id="current_stock_qty" type="text" readonly style="background-color: $ddd; ">
                        </div>
                    </div>
                </div>
                <div class="col-md-2">
